...
func openapiDinosaursYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "openapi.dinosaurs.yaml", size: 9546, mode: os.FileMode(420), modTime: time.Unix(1770598689, 0)}
...
func openapiYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "openapi.yaml", size: 4640, mode: os.FileMode(420), modTime: time.Unix(1770824380, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
